...
private:
	...
	int		MixerSourceMaxDelay(u_int32_t mixer_id, u_int32_t source_no, u_int32_t maxdelay);
	int		MixerSourceSilence(u_int32_t mixer_id, u_int32_t source_no, u_int32_t silence);
